...
Перед началом каждого боя игрок может выбрать один специальный перк, который влияет на вероятность критических ударов:

- **Удвоенная вероятность крита в голову** — удваивает шанс критического удара при атаке в верхнюю зону (10% → 20%)
- **Удвоенная вероятность крита в тело** — удваивает шанс критического удара при атаке в среднюю зону (5% → 10%)
- **Удвоенная вероятность крита в ноги** — удваивает шанс критического удара при атаке в нижнюю зону (5% → 10%)
...
- Активные перки отображаются под полосками здоровья игрока и противника
