...
- **TieBreaker** — при ничьей дает 3 HP вместо стандартных 2 HP
...
- **BlockMaster** — при успешной защите от всех трех ударов в серии восстанавливает 2 HP (не больше максимума)
...
- Активные перки отображаются под полосками здоровья игрока и противника (короткие названия: HeadHunter, BodyHunter, LegHunter, TieBreaker, HPBoost, CritDeflector, Lucker?, BlockMaster)
