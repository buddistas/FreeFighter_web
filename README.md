...
- **Equalizer** — если на конец раунда у владельца перка количество HP на 4+ меньше чем у противника, противник лишается 2 HP (работает в обычных и дополнительных раундах)
...
- Активные перки отображаются под полосками здоровья игрока и противника (короткие названия: HeadHunter, BodyHunter, LegHunter, TieBreaker, HPBoost, CritDeflector, Lucker?, BlockMaster, FinishHim, Equalizer)
