// Генератор сводной таблицы по новым турнирам (101-200) с баффнутым TieBreaker
const fs = require('fs');
...
let md = `# Сводная таблица результатов турниров (101-200)\n\n`;
md += `## Итоговая статистика по 100 турнирам с баффнутым TieBreaker (+2 HP)\n\n`;
md += `**Изменение:** TieBreaker теперь дает 4 HP вместо 2 HP при ничьей (было 3 HP)\n\n`;
...
// Сохраняем файл
const outputFile = path.join(__dirname, 'summary-buffed.md');
fs.writeFileSync(outputFile, md, 'utf8');

console.log('Сводная таблица создана: summary-buffed.md');
console.log(`\nОбработано турниров: 100 (101-200)`);
